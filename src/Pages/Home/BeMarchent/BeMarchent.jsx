    ...
    <div data-aos="zoom-in-up" className="bg-[url('assets/be-a-merchant-bg.png')] bg-no-repeat bg-[#03373D] rounded-4xl p-20">
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div>
          ...
          <button className="btn btn-primary rounded-4xl text-black">Become A Merchant</button>
          <button className="btn btn-primary rounded-4xl btn-outline text-black ms-4">Become A Merchant</button>
        </div>
      </div>
    </div>
  );
